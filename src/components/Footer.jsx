    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">My Etawah</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-sm">info@myetawah.com</span>
              </li>
              <li className="flex items-start space-x-2">
                <Instagram size={18} className="text-emerald-500 mt-0.5" />
                <span className="text-sm"> <a href="https://www.instagram.com/hey_etawah">hey_etawah</a> </span>
              </li>

              <li className="flex items-start space-x-2">
                <Phone size={18} className="text-emerald-500 mt-0.5" />
                <span className="text-sm">+911 (999) 888-7777</span>
              </li>
              <li className="flex items-start space-x-2">
                <MapPin size={18} className="text-emerald-500 mt-0.5" />
                <span className="text-sm">Pakka Bagh, Etawah, Uttar Pradesh, 206003</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} My Etawah. All rights reserved. Making the world a better place, one volunteer at a time.</p>
        </div>
      </div>
    </footer>
  );
